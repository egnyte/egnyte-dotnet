...
namespace Egnyte.Api.Tests.Groups
{
    ...
    public class CreateGroupTests
    {
        ...
        public async Task CreateGroup_ReturnsSuccess()
        {
            ...
            Assert.AreEqual(
                RemoveWhitespaces(CreateGroupRequestContent),
        ...
        public async Task CreateGroup_WithoutMembers_ReturnsSuccess()
        {
            ...
            var content = httpHandlerMock.GetRequestContentAsString();
            Assert.AreEqual(
                RemoveWhitespaces(CreateGroupWithoutMembersRequestContent),
                RemoveWhitespaces(content));
        ...
        [Test]
        public async Task CreateGroupTests_WhenDisplayNameEmpty_ThrowsException()
        {
        ...
        [Test]
        public async Task CreateGroupTests_WhenMembersAreNull_ThrowsException()
        {
            var httpClient = new HttpClient(new HttpMessageHandlerMock());
            var egnyteClient = new EgnyteClient("token", "acme", httpClient);
